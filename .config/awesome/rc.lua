...
globalkeys = my_table.join(
    ...
    function ()
        awful.spawn(string.format("dmenu_run -i -nb '#191919' -nf '#fea63c' -sb '#fea63c' -sf '#191919' -fn NotoMonoRegular:bold:pixelsize=18",
    ...
    -- super + shift + ...
    awful.key({ modkey, "Shift"   }, "Return", function() awful.util.spawn( "rofi -no-config -no-lazy-grab -show drun -modi drun -theme ~/.config/polybar/scripts/rofi/launcher.rasi  ") end),
...
--          properties = { callback = function (c) c.maximized = false end } },
    ...
    { rule_any = {
        ...
        class = {
          ...
          "Wpa_gui",
          "pinentry",
          "Burp Suite Community Edition v2020.12.1",
          "discord",
          "TelegramDesktop",
          "burp-StartBurp",
          "Xfce4-terminal"},
